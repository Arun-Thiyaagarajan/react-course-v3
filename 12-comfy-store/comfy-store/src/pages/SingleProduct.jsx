  ...
  return (
    <section>
      ...
      <div className="mt-6 grid gap-y-8 lg:grid-cols-2 lg:gap-x-16">
        <img src={image} alt={title} className='h-96 w-96 object-cover rounded-lg lg:w-full' />
        <div>
            ...
            <div className="mt-2">
              {colors.map(color => {
                return <button
                  key={color}
                  type='button'
                  className={`badge w-6 h-6 mr-2 transition duration-300 ${color === productColor && 'border-2 border-secondary'}`}

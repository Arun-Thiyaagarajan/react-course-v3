...
const getLayoutType = () => {
  const comfyLayout = localStorage.getItem("Comfy_LayoutType");
  const newLayout = comfyLayout || "grid";
  return newLayout;
}
      ...
      <div className="flex justify-between items-center mt-8 border-b border-base-300 pb-5">
        ...
        <div className="flex gap-x-2">
          <button
            type='button'
            onClick={() => {
              localStorage.setItem("Comfy_LayoutType", "grid")
              setLayout('grid')
            }}
          ...
          <button
            type='button'
            onClick={() => {
              localStorage.setItem("Comfy_LayoutType", "list")
              setLayout('list')
            }}
